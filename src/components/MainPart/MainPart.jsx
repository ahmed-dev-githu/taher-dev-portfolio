...
function MainPart() {
    ...
    return (
        ...
        <div className="WhoJop">
            ...
            <a href="Ahmed_Taher_ATS_CV_EN.pdf" download="Ahmed_Taher_ATS_CV_EN.pdf" style={{textDecoration : "none",color:"white"}}><button id='btn' className="button">Download CV</button></a>
